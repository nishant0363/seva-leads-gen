// const CONFIG = {
//   API_URL: "https://script.google.com/macros/s/AKfycbxu5GV6aXqMpBGR9tFHASf21DdquVHVxRkqogfKgh07WXtKNnKI9PgibfjmExi_jksK3w/exec"
// };

const CONFIG = {

  // ── Main property sheet (Form Responses 1) ──────────────────
  API_URL: "https://script.google.com/macros/s/AKfycbyiTdOs2dHn8bnSJ87P15BkRar9nPMS1tchQ47JuKSccGDUXuFwVSkPtt_NiQJESNBAjQ/exec",
  ...
  // ── Demand sheet ────────────────────────────────────────────
  // Columns: lat, lng, cluster, orders
  ...
  // ── Idle sheet ──────────────────────────────────────────────
  // Columns: lat, lng, cluster, hood, idle_min, w, hood_pings
  ...
  // Columns: hood_name, cluster_id, centroid_lat, centroid_lng
